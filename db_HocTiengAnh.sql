...
INSERT [dbo].[TUVUNG] ([VocabID], [TopicID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources], [Active], [Learned], [Level]) VALUES (1, 1, 1410, 'benefit', '/ˈbenɪfɪt/', 'noun', 'benefits', N'lợi ích', 'benefit from', 'on left', 'Although at a group level most benefit from ICS is obtained at a low dose, individual ICS responsiveness varies', N'Mặc dù lợi ích từ ICS liều thấp đều được ghi nhận ở cấp độ nhóm nhưng sự đáp ứng với ICS của mỗi cá nhân thì lại khác nhau.', 'GINA 2020. (attach file txt) ', 1, NULL, NULL)
INSERT [dbo].[TUVUNG] ([VocabID], [TopicID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources], [Active], [Learned], [Level]) VALUES (2, 1, 1410, 'benefit', '/ˈbenɪfɪt/', 'Verb', N'benefits/benefiting/benefited', N'hưởng lợi (từ), có được lợi ích', N'benefit from', N'on left', NULL, N'Một số bệnh nhân không kiểm soát được bệnh hen suyễn khi sử dụng ICS-LABA liều thấp (dù đã tuân thủ tốt và sử dụng bình hít đúng kỹ thuật) thì có thể được hưởng lợi từ việc tăng liều duy trì lên mức trung bình.', 'GINA 2020. (attach file txt) ', 1, NULL, NULL)
INSERT [dbo].[TUVUNG] ([VocabID], [TopicID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources], [Active], [Learned], [Level]) VALUES (3, 1, 2718, 'include', '/ɪnˈkluːd /', 'verb', N'includeing/included/includes', N'Bao gồm, bao hàm, gồm có, chứa trong', N'included in', N'on left', N'Some (e.g. diphenhydramine) may also be included in cold remedies for their supposed antitussive action.', N'Một số thuốc (ví như như: diphenhylamine) cũng có thể bao gồm trong các biện pháp điều trị cảm lạnh với tác dụng trị ho của các thuốc này.', 'Symptoms in the Pharmacy_ A Guide to the Management of Common Illnesses-Wiley-Blackwell (2018). (attach file txt) ', 1, NULL, NULL)
INSERT [dbo].[TUVUNG] ([VocabID], [TopicID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources], [Active], [Learned], [Level]) VALUES (4, 2, 2736, 'low', '/ləʊ /', 'adjective', 'lower; 
lowly (adv)"', N'thấp, nhỏ', N'rate', N'on left', N'Most studies with LABA/LAMA combinations have been performed in patients with a low rate of exacerbations. ', N'Hầu hết các nghiên cứu với sự kết hợp LABA và LAMA đã được thực hiện ở những bệnh nhân lên cơn cấp với tần suất thấp.', 'GLOBAL STRATEGY FOR THE DIAGNOSIS, MANAGEMENT, AND PREVENTION OF CHRONIC OBSTRUCTIVE PULMONARY DISEASE (2018 REPORT). (attach file txt) ', 1, NULL, NULL)
INSERT [dbo].[TUVUNG] ([VocabID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources], [Active], [Learned], [Level]) VALUES (5, 2160, N'clinical', N'/kl??n??n /', N'adverb', N'clinical', N'lâm sàng, thuộc hoặc liên quan đến việc khám và điều trị bệnh nhân', 'clinical diagnosis', 'on left', 'The risk of misdiagnosis and over-treatment of individual patients using the fixed ratio (FEV1/FVC) as a diagnostic criterion is limited, as spirometry is only one parameter for establishing the clinical diagnosis of COPD', N'Nguy cơ chẩn đoán sai và điều trị quá mức đối ở từng bệnh nhân sử dụng fixed ratio (FEV1/FVC) làm tiêu chuẩn chẩn đoán thì còn hạn chế, vì phế dung kế chỉ là một trong các thông số đùng trong chẩn đoán lâm sàng của bệnh COPD', 'GLOBAL STRATEGY FOR THE DIAGNOSIS, MANAGEMENT, AND PREVENTION OF CHRONIC OBSTRUCTIVE PULMONARY DISEASE (2018 REPORT). (attach file txt) ', 1, NULL, NULL)
...
INSERT [dbo].[TUVUNGCANHAN] (PersonalVocabID, [VocabID], [AccountID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources]) VALUES (1, 1, 2, 1410, 'benefit', '/ˈbenɪfɪt/', 'noun', 'benefits', N'lợi ích', 'benefit from', 'on left', N'Although at a group level most benefit from ICS is obtained at a low dose, individual ICS responsiveness varies', N'Mặc dù lợi ích từ ICS liều thấp đều được ghi nhận ở cấp độ nhóm nhưng sự đáp ứng với ICS của mỗi cá nhân thì lại khác nhau.', N'GINA 2020. (attach file txt) ')
INSERT [dbo].[TUVUNGCANHAN] (PersonalVocabID, [VocabID], [AccountID], [Frquency], [Word], [IPA], [Label], [Lemma], [Vietnamese], [Cluster], [Position], [Example], [VN_Example], [Resources]) VALUES (2, 2, 1, 2736, 'low', '/ləʊ /', 'adjective', 'lower; 
